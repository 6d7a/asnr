...
pub trait DecodeMember<'a, I: AsBytes + 'a> {
...
pub trait Decoder<'a, I: AsBytes + 'a> {
    ...
    fn decode_choice<O: DecoderForIndex<'a, I>>(choice: Choice) -> Result<Box<dyn FnMut(I) -> IResult<I, O>>, DecodingError>;
