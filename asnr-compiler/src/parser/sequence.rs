...
mod tests {
    ...
    //                   Constraint::ComponentConstraint(InnerTypeConstraint { is_partial: true, constraints: vec![ConstrainedComponent { identifier: "elliptical".into(), constraints: vec![], presence: ComponentPresence::Absent }, ConstrainedComponent { identifier: "radial".into(), constraints: vec![], presence: ComponentPresence::Absent }, ConstrainedComponent { identifier: "radialShapes".into(), constraints: vec![], presence: ComponentPresence::Absent }] })]}),
    //                 default_value: None,
    //                 is_optional: true,
    //                 constraints: vec![],
    //             }
    ...
    //                                         constraints: vec![Constraint::ValueConstraint(
    //                                             ValueConstraint {
    //                                                 min_value: Some(ASN1Value::Integer(1)),
